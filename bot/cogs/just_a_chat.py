...
class JustAChat(commands.Cog, name='Just a chat...'):
	...
	async def jsguidelines(self, ctx, paginator='off'):
		...
		conlangs.add_field(name='naia ivik',
		                   value='amino v uxrdvömeŋaadrŋre dru xalŋdöŋ!\n'
		...
		conlangs_ext.add_field(name='VötGil',
		...
		conlangs_ext.add_field(name='наиа ивик',
		                       value='амино в ухрдвөмеңаадрңре дру халңдөң!\n'
